        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
                ...
                <div class="menu-item">
                    ...
                    <a class="menu-link {{Request::is('/dashboard') ? 'active' : ''}}" href="/dashboard">
                        <span class="menu-icon">
                            ...
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="gray" class="bi bi-house-door-fill" viewBox="0 0 16 16">
                    ...
                    <a class="menu-link {{Request::is('/vendor-user') ? 'active' : ''}}" href="/vendor-user">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotone/Design/PenAndRuller.svg-->
                            <span class="svg-icon svg-icon-2">
                    ...
                    <a class="menu-link" href=" {{url('manage-componies')}}">
                        ...
                        <span class="menu-title">Manage Rental Companies</span>
                    </a>
                    <a class="menu-link" href=" {{url('vehicle-makes')}}">
                        ...
                        <span class="menu-title">Vehicle Makes</span>
                    </a>
                    <a class="menu-link" href=" {{url('vehicle-models')}}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotone/Design/PenAndRuller.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                    ...
                    <a class="menu-link" href=" {{url('vehicles')}}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotone/Design/PenAndRuller.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                    ...
                    <a class="menu-link {{Request::is('/') ? 'active' : ''}}" href=" {{url('manage-insurance-componies')}}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotone/Design/PenAndRuller.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        ...
                        <span class="menu-title">Manage Insurance Companies</span>
                    </a>

                    <a class="menu-link {{Request::is('/') ? 'active' : ''}}" href=" {{url('sub-insurance-componies')}}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotone/Design/PenAndRuller.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        ...
                        <span class="menu-title">Sub Insurance Companies</span>
                    </a>

                    {{-- <a class="menu-link {{Request::is('/') ? 'active' : ''}}" href=" {{url('assign-vehicle')}}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotone/Design/PenAndRuller.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        ...
                        <span class="menu-title">Assign Vehicle</span>
                    </a> --}}
                    <a class="menu-link {{Request::is('/') ? 'active' : ''}}" href=" {{url('terms-conditions')}}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotone/Design/PenAndRuller.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        ...
                        <span class="menu-title">Manage Terms & Conditions</span>
                    </a>
                    <a class="menu-link {{Request::is('/') ? 'active' : ''}}" href=" {{url('rental-agreements')}}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotone/Design/PenAndRuller.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                    ...
                    <a class="menu-link {{Request::is('/userAccounts') ? 'active' : ''}}" href="/userAccounts">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotone/Design/PenAndRuller.svg-->
                            <span class="svg-icon svg-icon-2">
                    ...
                    <a class="menu-link {{Request::is('/AdminAccounts') ? 'active' : ''}}" href="/adminAccounts">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotone/Design/PenAndRuller.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="gray" class="bi bi-shield-check" viewBox="0 0 16 16">
                    ...
                    <a class="menu-link {{Request::is('/ServiceProvider') ? 'active' : ''}}" href="/provider">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotone/Design/PenAndRuller.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="gray" class="bi bi-person-fill-check" viewBox="0 0 16 16">
                    ...
                    <a class="menu-link {{Request::is('/Approvals') ? 'active' : ''}}" href="/approvals">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotone/Design/PenAndRuller.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="gray" class="bi bi-card-list" viewBox="0 0 16 16">
                    ...
                    <a class="menu-link {{Request::is('/dispute') ? 'active' : ''}}" href="/dispute">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotone/Design/PenAndRuller.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="gray" class="bi bi-credit-card-fill" viewBox="0 0 16 16">
                    ...
                    @endif
                    @if(Auth::user()->hasAnyRole(['vendor_user']))
                    <!--   vender -->
